...
app/            # UI 層：只 render + 呼叫 src/，禁止商業邏輯
  ...
  pages/        # 0_Overview / 1_Product / 2_Customer / 3_Trend / 4_Cost / 5_Admin / 6_Key_Accounts（薄殼，共 7 頁）
  components/   # filters, kpi_cards, charts, data_loader
    views/      # 頁面實際內容在這（trend/product/cost/customer/key_accounts/admin）——改 UI 先找這裡
